...
/// <summary>
 ...
 public class WeightedMultiGraph<NodeLabel, EdgeLabel> {
    ...
    void Start()
    {
        ...
        //attack vertices
        var attack_1 = G.addVertex("Attack1", true);
        var attack_2 = G.addVertex("Attack2");
        var attack_3 = G.addVertex("Attack3");
        var attack_4 = G.addVertex("Attack4");
        var attack_5 = G.addVertex("Attack5");
        var attack_6 = G.addVertex("Attack6");
        var attack_7 = G.addVertex("Attack7");
        var attack_8 = G.addVertex("Attack8");
        var attack_9 = G.addVertex("Attack9");
        var attack_10 = G.addVertex("Atack10");
        
        //missed vertices
        var missed_1 = G.addVertex("Missed1");
        var missed_2 = G.addVertex("Missed2");
        var missed_3 = G.addVertex("Missed3");
        var missed_4 = G.addVertex("Missed4");
        var missed_5 = G.addVertex("Missed5");
        var missed_6 = G.addVertex("Missed6");
        var missed_7 = G.addVertex("Missed7");
        var missed_8 = G.addVertex("Missed8");
        var missed_9 = G.addVertex("Missed9");
        var missed_10 = G.addVertex("Missed10");

        var playerdead = G.addVertex("PlayerDead", false, true);
        //Attack1
        G.addEdge(attack_1, attack_2, "hit", 0.3, 2.0);
        G.addEdge(attack_1, missed_1, "miss", 0.7, -1.0);
        G.addEdge(missed_1, attack_1, "try again", 1.0, -2.0);

        //Attack2
        G.addEdge(attack_2, attack_3, "hit", 0.3, 2.0);
        G.addEdge(attack_2, missed_2, "miss", 0.7, -1.0);
        G.addEdge(missed_2, attack_2, "try again", 1.0, -1.0);

        //Attack3
        G.addEdge(attack_3, attack_4, "hit", 0.3, 2.0);
        G.addEdge(attack_3, missed_3, "miss", 0.7, -1.0);
        G.addEdge(missed_3, attack_3, "try again", 1.0, -1.0);

        //Attack4
        G.addEdge(attack_4, attack_5, "hit", 0.3, 2.0);
        G.addEdge(attack_4, missed_4, "miss", 0.7, -1.0);
        G.addEdge(missed_4, attack_4, "try again", 1.0, -1.0);

        //Attack5
        G.addEdge(attack_5, attack_6, "hit", 0.3, 2.0);
        G.addEdge(attack_5, missed_5, "miss", 0.7, -1.0);
        G.addEdge(missed_5, attack_5, "try again", 1.0, -1.0);

        //Attack6
        G.addEdge(attack_6, attack_7, "hit", 0.3, 2.0);
        G.addEdge(attack_6, missed_6, "miss", 0.7, -1.0);
        G.addEdge(missed_6, attack_6, "try again", 1.0, -1.0);

        //Attack7
        G.addEdge(attack_7, attack_8, "hit", 0.3, 2.0);
        G.addEdge(attack_7, missed_7, "miss", 0.7, -1.0);
        G.addEdge(missed_7, attack_7, "try again", 1.0, -1.0);

        //Attack8
        G.addEdge(attack_8, attack_9, "hit", 0.3, 2.0);
        G.addEdge(attack_8, missed_8, "miss", 0.7, -1.0);
        G.addEdge(missed_8, attack_8, "try again", 1.0, -1.0);

        //Attack9
        G.addEdge(attack_9, attack_10, "hit", 0.3, 2.0);
        G.addEdge(attack_9, missed_9, "miss", 0.7, -1.0);
        G.addEdge(missed_9, attack_9, "try again", 1.0, -1.0);

        //Attack10
        G.addEdge(attack_10, playerdead, "hit&playerdead", 0.3, 10.0);
        G.addEdge(attack_10, missed_10, "miss", 0.7, -1.0);
        G.addEdge(missed_10, attack_10, "try again", 1.0, -1.0);
